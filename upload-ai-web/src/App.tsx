      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Lembre-se: você pode usar a variável <code className="text-violet-500">{'{transcription}'}</code> para adicionar a transcrição do vídeo selecionado.
          </p>
        </div>
